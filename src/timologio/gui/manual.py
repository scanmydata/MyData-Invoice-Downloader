...
<p>
Τσεκάρετε στο πρώτο κουτάκι όσους πελάτες θέλετε (ή «Επιλογή όλων») και μετά:
</p>
<ul>
  <li>πατήστε το πλήκτρο <b>Delete</b>, ή</li>
  <li>δεξί κλικ &rarr; <b>«Διαγραφή N τσεκαρισμένων πελατών»</b>.</li>
</ul>
<p style="color:{p.muted};">
Χωρίς κανέναν τσεκαρισμένο, το Delete σβήνει όσους είναι <i>φωτισμένοι</i>
(κλικ, ή Ctrl/Shift+κλικ για πολλούς). Πάντα προηγείται παράθυρο επιβεβαίωσης
που λέει πόσοι πελάτες και πόσες εγγραφές θα σβηστούν, και πάντα κρατιέται
αντίγραφο ασφαλείας.
</p>
